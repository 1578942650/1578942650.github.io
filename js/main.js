...
(function() {
	...
	function runAnimation() {
		...
		if( step === 3 ) {
			...
			setGridDelays();
			setTimeout(function() { letflowerfall(); },750);
			setTimeout(function() { showbackground(); },4500);
			setTimeout(function() { showtheword(); },6000);
		}
	...
	function showtheword() {
    	...
    	$("#thirdpageword").fadeIn(3000);
    	$("#thirdpageword2").fadeIn(3000);
  		});
  	}

	function showbackground(){
        	$(function(){
    		$("#thirdpagewallpaper").fadeIn(1000);
			});
	}
